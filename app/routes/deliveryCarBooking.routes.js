...
module.exports = function (app) {
  ...
  app.get(
    "/api/delivery_car_booking_byIdDriver/:idDriver",
    [authJwt.verifyToken],
    DeliveryCarBookingController.getDeliveryCarBookingByIdDriver
  );
  ...
  app.post(
    "/api/delivery_car_booking_ByFilter_ByIdDriver",
    [authJwt.verifyToken],
    DeliveryCarBookingController.getDeliveryCarBookingByFilterByIdDriver
  );
};
